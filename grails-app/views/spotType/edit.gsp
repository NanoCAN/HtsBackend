...
<html>
	...
	<body>
		<a href="#edit-spotType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    <div class="navbar">
    ...
    <div id="edit-spotType" class="content scaffold-edit" role="main">
			...
			<g:form method="put" >
				...
				<g:hiddenField name="version" value="${spotTypeInstance?.version}" />
				<fieldset class="form">
