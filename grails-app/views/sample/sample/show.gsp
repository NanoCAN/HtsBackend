	...
	<body>
		...
		<div id="show-sample" class="content scaffold-show" role="main">
			...
			<ol class="property-list sample">
				...
				<g:if test="${sampleInstance?.controlType}">
				<li class="fieldcontain">
				...
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="sample.type.label" default="Type" /></span>
						...
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${sampleInstance}" field="type"/></span>
				...
				<li class="fieldcontain">
					<span id="target-label" class="property-label"><g:message code="sample.target.label" default="Target" /></span>
						...
						<span class="property-value" aria-labelledby="target-label"><g:fieldValue bean="${sampleInstance}" field="target"/></span>
				...
				<li class="fieldcontain">
					<span id="color-label" class="property-label"><g:message code="sample.color.label" default="Color" /></span>
					
						<span class="property-value" aria-labelledby="color-label"><g:fieldValue bean="${sampleInstance}" field="color"/></span>
				...
				<li class="fieldcontain">
					<span id="control-label" class="property-label"><g:message code="sample.control.label" default="Control" /></span>
					
						<span class="property-value" aria-labelledby="control-label"><g:formatBoolean boolean="${sampleInstance?.control}" /></span>
				...
				<li class="fieldcontain">
					<span id="identifiers-label" class="property-label"><g:message code="sample.identifiers.label" default="Identifiers" /></span>
