...
<body>
<a href="#create-resultFileConfig" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-resultFileConfig" class="content scaffold-create" role="main">
