...
<body>
<a href="#edit-inducer" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-inducer" class="content scaffold-edit" role="main">
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${inducerInstance?.version}"/>
        <fieldset class="form">
