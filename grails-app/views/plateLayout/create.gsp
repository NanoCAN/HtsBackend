...
<body>
<a href="#create-plateLayout" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-plateLayout" class="content scaffold-create" role="main">
